...
class GridWorld():
    ...
    def new_grid(self):
        ...
        self.run = False
    # Extra Credits
    def extra_grid1(self):
        self.grid = Grid(self)
        self.agent = Agent(self.grid, self.grid.start, self.grid.goal, self.type)
        self.grid.all_green()
        self.run = False
    def extra_grid2(self):
        self.grid = Grid(self)
        self.agent = Agent(self.grid, self.grid.start, self.grid.goal, self.type)
        self.grid.hi()
        self.run = False
    ...
    def all_green(self):
        for col in self.nodes:
            for node in col:
                node.all_grass()
    def hi(self):
        self.nodes[5][5].puddle = True
        self.nodes[6][5].puddle = True
        self.nodes[7][5].puddle = True
        self.nodes[8][5].puddle = True
        self.nodes[9][5].puddle = True
        self.nodes[10][5].puddle = True
        self.nodes[11][5].puddle = True
        self.nodes[12][5].puddle = True
        self.nodes[13][5].puddle = True
        self.nodes[9][6].puddle = True
        self.nodes[9][7].puddle = True
        self.nodes[9][8].puddle = True
        self.nodes[9][9].puddle = True
        self.nodes[5][10].puddle = True
        self.nodes[6][10].puddle = True
        self.nodes[7][10].puddle = True
        self.nodes[8][10].puddle = True
        self.nodes[9][10].puddle = True
        self.nodes[10][10].puddle = True
        self.nodes[11][10].puddle = True
        self.nodes[12][10].puddle = True
        self.nodes[13][10].puddle = True
        self.nodes[7][14].puddle = True
        self.nodes[9][14].puddle = True
        self.nodes[10][14].puddle = True
        self.nodes[11][14].puddle = True
        self.nodes[12][14].puddle = True
        self.nodes[13][14].puddle = True
        for col in self.nodes:
            for node in col:
                node.random_grass()
    def update(self):
